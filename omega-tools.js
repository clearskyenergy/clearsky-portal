...
(function (global) {
  ...
  var SEED_TOOLS = [
    ...
    { key:'ahj', name:'AHJ Approval Portal', category:'permitting',
      desc:'Submit & track permit approvals with the AHJ.',
      file:'/ahj-portal.html', soon:true, tier:TIER.ENTERPRISE,
    ...
    { key:'financing', name:'Financing Partners', category:'marketplace',
      desc:'Deal room for developers & capital partners.',
      file:'/financing.html', soon:true, tier:TIER.ALL,
